...
// Generation liste des societes
	...
	if (GETPOST("filter","alpha")) $sql.= " AND ".GETPOST("filter","alpha"); // Add other filters
	$sql.= " ORDER BY nom ASC";
//dol_syslog('ajaxcompagnies - sql:'. $sql);
	dol_syslog("ajaxcompanies - sql".$sql, LOG_DEBUG);
	$resql=$db->query($sql);
	if ($resql)
	{
