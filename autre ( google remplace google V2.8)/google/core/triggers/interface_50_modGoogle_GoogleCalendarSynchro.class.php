 ...
 *
 * MODIF CCA 12/6/2019 - n'envoyer à Google que les actions paramétrée dans conf->global au format MAIN_GOOGLE_ACTIONAUTO_[code action]
 * MODIF CCA - 12/6/19 - - n'envoyer à Google que les actions paramétrée dans conf->global au format MAIN_GOOGLE_ACTIONAUTO_[code action]
 *
...
// MODIF CCA - 12/6/15 - n'envoyer à Google que les évènements 4 saisons, codé dans type_code
		global $conf; 
		$key = 'MAIN_GOOGLE_ACTIONAUTO_'.$object->type_code;
