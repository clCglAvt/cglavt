 ...
 *
 * Modif CCA  - 2018 - depots de moyen de paiement multiple
 * MODIF CCA 18/05/2021 - Montée version PHP
 *
...
//Modif CCA  - dépôts de moyen de paiement multiple
	if ($object->element == 'paiement') $modulepart='deposit';
// Fin Modif CCA
...
//			$cpt = ($page - $maxnbofpage);
			$cpt = ((int)$page - $maxnbofpage);
//Fin Modif CCA - 18/05/2021 - Montée version PHP
			if ($cpt < 0) {
				$cpt = 0;
			}
...
// MODIF CCA 18/05/2021 - Montée version PHP
					//	$pagelist .= '<li class="pagination"><span class="active">'.($page + 1).'</span></li>';
						$pagelist .= '<li class="pagination"><span class="active">'.((int)$page + 1).'</span></li>';
// FIN MODIF CCA 18/05/2021 - Montée version PHP
					} else {
...
// MODIF CCA 18/05/2021 - Montée version PHP
			...
			} while ($cpt < $nbpages && $cpt <= ((int)$page + (int)$maxnbofpage));
// FIN MODIF CCA 18/05/2021 - Montée version PHP
...
//			$pagelist .= '<li class="pagination"><span class="active">'.($page + 1)."</li>";
			$pagelist .= '<li class="pagination"><span class="active">'.((int)$page + 1)."</li>";
// FIN MODIF CCA 18/05/2021 - Montée version PHP
		}
	}
...
//MODIF CCA 18/05/2021 - Montée version PHP
		//print '<li class="pagination paginationpage paginationpageright"><a class="paginationnext" href="'.$file.'?page='.($page + 1).$options.'"><i class="fa fa-chevron-right" title="'.dol_escape_htmltag($langs->trans("Next")).'"></i></a></li>';
		  print '<li class="pagination paginationpage paginationpageright"><a class="paginationnext " href="'.$file.'?page='.((int)$page + 1).$options.'"><i class="fa fa-chevron-right" title="'.dol_escape_htmltag($langs->trans("Next")).'"></i></a></li>';
//Fin MODIF CCA 18/05/2021 - Montée version PHP
	}
	if ($afterarrows) {
