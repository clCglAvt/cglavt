...
// Fin Modif CCA
        ...
        {
//modif CCA 15/01/2020 - Demande Stripe
            //print '<tr><td>';
            print '<tr id="trSmsTo"><td>';
//fin modif CCA 15/01/2020 - Demande Stripe
...
// Modif CCA 15/01/2020	
		if (isset($_POST["message"]) && ! $_POST['modelselected']) {
			...
			$defaultlines=$_POST["message_lines"];
		}
            ...
            $defaultmessage=str_replace('\n', "\n", $defaultmessage);
            $defaultmessage=str_replace('<br />', "", $defaultmessage);
            $defaultmessage=str_replace('<a href="', "", $defaultmessage);
            $defaultmessage=str_replace('</a>', "", $defaultmessage);
		   ...
		   print '<td class="tdtop">'.$langs->trans("SmsText");
			print $form->textwithpicto($langs->trans(''), $help, 1, 'help', '', 0, 2, 'substittooltipfrombody');
		   print "</td>";
// Fin Modif CCA 15/01/2020
            print "<td>";
	 ...
	 *
	 * @param	string	$mode		'formesms', 'formesmswithlines', 'formesmsforlines', 'emailing', ...
	 * @param	Object	$object		Object if applicable
	 * @return	array               Array of substitution values for emails.
	 */
	public static function getAvailableSubstitKey($mode = 'formesms', $object = null)
	{
		global $conf, $langs;

		$tmparray=array();
		if ($mode == 'formesms' || $mode == 'formesmswithlines' || $mode == 'formesmsforlines')
		{
