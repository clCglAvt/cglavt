 ...
 *
 * modif CCA 3/8/2017 - Mettre le model choisi en pre-selection dans le select
 * Modif CCA 25/08/2019 - Suppression 1 seul fichier *
 * Modif CCA 4/12/2019 - Demande Stripe 
 *
...
// CCA MODIF 25/8/2019 - Suppression 1 seul fichier
//		if (GETPOST('mode', 'alpha') == 'init' || (GETPOST('modelselected') && GETPOST('modelmailselected', 'alpha') && GETPOST('modelmailselected', 'alpha') != '-1')) {
		if (GETPOST('mode','alpha') == 'init' || (GETPOST('modelselected','alpha') && GETPOST('modelselected','alpha') != '-1' && GETPOST('modelmailselected', 'alpha') && GETPOST('modelmailselected', 'alpha') != '-1')) {
// CCA MODIF 25/8/2019 - Suppression 1 seul fichier
...
//modif CCA 4/12/2019 - Demande Stripe
				...
				$out.= '<div id="DivSelectMailModel" class="center" style="padding: 0px 0 12px 0">'."\n";
//fin modif CCA 4/12/2019 - Demande Stripe
//modif CCA 3/8/2017 - Mettre le model choisi en pre-selection dans le select
...
//				$out .= $this->selectarray('modelmailselected', $modelmail_array, $model_mail_selected_id, 1, 0, 0, '', 0, 0, 0, '', 'minwidth100', 1, '', 0, 1);
				$out.= '<span class="opacitymedium">'.$langs->trans('SelectMailModel').':</span> ';
				$out .= $this->selectarray('modelmailselected', $modelmail_array,  $model_id, 1, 0, 0, '', 0, 0, 0, '', 'minwidth100', 1, '', 0, 1	);
// Fin Modif CCA 3/8/2017
				if ($user->admin) {
...
//CCA Modif 25/8/2019 - SUppression 1 seul fichier
				...
				if (isset($defaultlines) and ! empty($this->substit_lines)) {
//Fin CCA Modif 25/8/2019 -
...
//modif CCA 4/12/2019 - Demande Stripe
				...
				$out.= '<tr id="trMailTo"><td class="fieldrequired">';
//fin modif CCA 4/12/2019 - Demande Stripe
		if ($this->withtofree) {
