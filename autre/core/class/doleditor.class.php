 ...
 *
 * Modif CCA 5/5/23 - possibilité d'un évènement pour textarea	
 *
...
class DolEditor
{
	...
	public function Create($noprint = 0, $morejs = '', $disallowAnyContent = true, $titlecontent = '', $option = '')
	{
		...
		global $conf, $langs;
// Modif CCA 5/5/23 - possibilité d'un évènement pour textarea			
	    global		$event_filtre_car_saisie;	//			 pour ajout d'un évenement ex: onclick="<votre fonction js>"
// Fin 	Modif CCA 5/5/23
...
// Modif CCA 5/5/23 - possibilité d'un évènement pour textarea	
			...
			$out .= '<textarea id="'.$this->htmlname.'" name="'.$this->htmlname.'" rows="'.$this->rows.'"'.(preg_match('/%/', $this->cols) ? ' style="margin-top: 5px; width: '.$this->cols.'"' : ' cols="'.$this->cols.'"').' class="flat" '.$event_filtre_car_saisie.' >';
// Fin Modif CCA  5/5/23 
...
// Modif CCA 5/5/23 - possibilité d'un évènement pour textarea	
			...
			$out .= '<textarea id="'.$this->htmlname.'" name="'.$this->htmlname.'" style="width:0px; height: 0px; display: none;" '.$event_filtre_car_saisie.' >';
// Fin Modif CCA  5/5/23 
			$out .= htmlspecialchars($this->content);
			$out .= '</textarea>';
