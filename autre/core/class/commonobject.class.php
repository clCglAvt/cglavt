 ...
 *
 * Modif CCA V2.7 - Oct 2022 Ajout car le fetch est dans bulletin class et non dans cglinscription
 *
...
//Modif CCA V2.7 - OCt 2022 Ajout car le fetch est dans bulletin class et non dans cglinscription
				if ($origin == 'cglinscription') {
					$origin = $hookmanager->resArray['origin'];
				}
		}
//Fin Modif CCA V2.7 
		}
	 ...
	 * @param 	int 		$hideref 		1 to5298hide product reference. 0 by default
