 ...
 *
 * Modif CCA 8/4/2021 - pourvoir rechercher par Alias comme dans la recherche menu gauche de Dolibarr
 * Modif CCA 13/11/2022 - dans formconfil, pouvoir poser une ancre (à revoir)
// Modif CCA 12/12/2022 - dans select_comptes - Suppression affichage nb enregistrement
 *	
...
//Modif CCA 8/4/2021 - pourvoir rechercher par Alias
//				$sql .= "(s.nom LIKE '".$this->db->escape($prefix.$crit)."%')";
				$sql.="(s.nom LIKE '".$this->db->escape($prefix.$crit)."%' or s.name_alias LIKE '".$this->db->escape($prefix.$crit)."%')";
// Fin Modif CCA
				$i++;
			}
