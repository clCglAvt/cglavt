 ...
 *
 * Modif CCA - 15/12/2019 - Si Acompte juste preuve de paiement - un dépot doit être effaçable surtout s'il n'est pas encaissé
 * Modif CCA - 10/6/2023 - Intégration de l'acompte fournisseur dans Reste à payer de la facture associée
 *					Conseil de https://www.dolibarr.fr/forum/t/deduction-des-factures-dacomptes-fournisseur-dans-les-factures-finales-fournisseur/38634/3
 *							Issue #19724
 *
...
abstract class CommonInvoice extends CommonObject
{
	...
	{
//Modif CCA 10/6/23 - Intégration de l'acompte fournisseur dans Reste à payer de la facture associée
/*		if ($this->element == 'facture_fourn' || $this->element == 'invoice_supplier') {
			// TODO
			return 0.0;
		}
*/
//Fin Modif CCA 10/6/23 
	...
	public function is_erasable()
	{
		...
		if ($tmppart !== 'PROV') {
// Modif CCA - 15/12/2019 - Acompte juste un ticket de dépot
...
// Fin Modif CCA - Acompte juste un ticket de dépot
...
// Modif CCA - 15/12/2019 Acompte juste un ticket de dépot
			...
			if ($this->element != 'invoice_supplier' and ($this->type !=  3 or  ($this->type ==  3 and empty($conf->global->FACTURE_DEPOSITS_ARE_JUST_PAYMENTS)))) { 
// Fin Modif CCA - Acompte juste un ticket de dépot
