...
//Modif CCA 17/10/2015 Ajout ventilation à export facture
			'fk_code_ventilation'=>'IdComptVentil',		 
...
// Modif CCA 17/10/2015 Ajout ventilation à export facture
			'fk_code_ventilation'=>'Numeric',
		     'cp.account_number' => 'Numeric',
// Fin Modif
...
// Modif CCA 17/10/2015 Ajout ventilation à export facture
			'fk_code_ventilation'=>'invoice_line',
			'cp.account_number' => 'accounting_account',
// Fin Modif	
...
// Modif CCA 17/10/2015 Ajout ventilation à export facture
		...
		$this->export_dependencies_array[$r] = array('invoice_line'=>'fd.rowid', 'product'=>'fd.rowid' ,'accounting_account'=>'fk_code_ventilation', 'none.rest'=>array('f.rowid', 'f.total_ttc'));
// Fin Modif
...
// Modif CCA 17/10/2015 Ajout ventilation à export facture
		$this->export_sql_end[$r] .= ' LEFT JOIN '.MAIN_DB_PREFIX.'accounting_account as cp on cp.rowid = fd.fk_code_ventilation';
// Fin Modif
