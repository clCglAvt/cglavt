...
/**
 *	\file       htdocs/core/modules/propale/pdf_rubis.modules.php
 *	\ingroup    propale
...
/**
 *	\class      pdf_rubis
 *	\brief      Classe permettant de generer les propales au modele rubis
 */
class pdf_rubis extends ModelePDFPropales
{
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "rubis";
		$this->description = $langs->trans('DocModelrubisDescription');
