 ...
 * Modif CCA 27/11/18 - Evolution de version 8.0.3 - est-ce nécessaire
 *
...
//fin Modif CCA 25/2/2014 - 
   ...
   // phpcs:disable PEAR.NamingConventions.ValidFunctionName.ScopeNotCamelCaps
    ...
    public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		// Load traductions files requiredby by page
		$outputlangs->loadLangs(array("main", "bills", "products", "dict", "companies","products"));
...
//Modif CCA 3/3/2014 - Immatriculation Opérateur
				...
				$pdf->SetXY($col1x, $tab2_top + $tab2_hl * $index +8);				
