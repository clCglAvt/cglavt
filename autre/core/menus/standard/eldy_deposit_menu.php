 ...
 *
 * MODIF CCA - Ajout déposit - verson 8.0.3 le 2/12/2018
 *
...
/**
 *	copie de      htdocs/core/menus/standard/eldy_menu.php
MODIF CCA  2/12/2018 Ajout déposit
 *	\file       htdocs/core/menus/standard/eldy_deposit_menu.php
 *	\brief      Menu Cgl manager
 * Fin Modif CCA - 
 */
 ...
 /**
 * Modif CCA - Ajout déposit - verson 8.0.3 le 2/12/2018
 *	Class to manage menu Eldy_deposit
 * Fin Modif CCA - 
 */
...
//MODIF CCA  2/12/2018 Ajout déposit
        ...
        $menuArbo = new Menubase($this->db, 'eldy_deposit');
        //$menuArbo->menuLoad($mainmenu, $leftmenu, $this->type_user, 'eldy', $tabMenu);
        $menuArbo->menuLoad($mainmenu, $leftmenu, $this->type_user, 'eldy_deposit', $tabMenu);
// FIN MODIF CCA
...
//MODIF CCA  2/12/2018 Ajout déposit
       ...
       require_once DOL_DOCUMENT_ROOT.'/core/menus/standard/eldy_deposit.lib.php';
// Fin MODIF CCA
...
//MODIF CCA  2/12/2018 Ajout déposit
        	...
        	//}
			if ($mode == 'top')  {
				print_eldy_deposit_menu($this->db,$this->atarget,$this->type_user,$this->tabMenu,$this->menu,0,$mode);
			}
        	if ($mode == 'left') {
				print_left_eldy_deposit_menu($this->db,$this->menu_array,$this->menu_array_after,$this->tabMenu,$this->menu,0,'','',$moredata, $this->type_user);
			}
// Fin MODIF CCA
		} else {
...
*/
        	if ($mode == 'top')  {
				print_left_eldy_deposit_menu($this->db,$this->menu_array,$this->menu_array_after,$this->tabMenu,$this->menu,0);
			}
        	if ($mode == 'left') {
				print_eldy_deposit_menu($this->db,$this->atarget,$this->type_user,$this->tabMenu,$this->menu,0,$mode, $this->type_user);
			}
// Fin MODIF CCA				
		}
		if ($mode == 'topnb') {
//MODIF CCA  2/12/2018 Ajout déposit
		    ...
		    print_eldy_deposit_menu($this->db,$this->atarget,$this->type_user,$this->tabMenu,$this->menu,1,$mode);  // no output
// Fin MODIF CCA
...
//MODIF CCA  2/12/2018 Ajout déposit
            ...
            print_eldy_deposit_menu($this->db,$this->atarget,$this->type_user,$this->tabMenu,$this->menu,1,$mode);      // Fill this->menu that is empty with top menu
// Fin MODIF CCA
...
//MODIF CCA  2/12/2018 Ajout déposit
	        		...
	        		print_left_eldy_deposit_menu($this->db,$this->menu_array,$this->menu_array_after,$this->tabMenu,$submenu,1,$tmpmainmenu,$tmpleftmenu, null, $this->type_user);       // Fill $submenu (example with tmpmainmenu='home' tmpleftmenu='all', return left menu tree of Home)
// Fin MODIF CCA       		
