 ...
 *
 * MODIF CCA 22/03/17 - sélection champ spécifiquement vide : null
 *
...
// MODIF CCA - 20/03/2017 - Text NULL
				} elseif  (strlen(stristr($ValueField, 'null'))>0) {
						$szFilterQuery.=" ".$NameField." is null";
// Fin Modif CCA
				} else {
