 ...
 *
 * Modif CCA - 22/10/2019 - Couleur associée au user
 *
...
//Modif CCA - 22/10/2019 - Couleur associé au user		
		//print '<div class="login_block usedropdown">'."\n";
		print '<div class="login_block usedropdown" style="background-color:#'.$user->color.'">'."\n";
//Fin Modif CCA - 22/10/2019 - Couleur associé au user
...
//Modif CCA - 22/10/2019 - Couleur associée au user
		...
		print "\n".'<!-- Begin side-nav id-left -->'."\n".'<div class="side-nav"><div id="id-left" style="background-color:#'.$user->color.'">'."\n";
 
//Fin Modif CCA - 22/10/2019 - Couleur associée au user
