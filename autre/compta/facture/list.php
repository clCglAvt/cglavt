 ...
 *
 * Modif CCA - 27/01/2019 - Acompte juste paiement
 * Modif CCA - 20/12/2023 - Acompte juste paiement	
 *
...
// Modif CCA - 20/12/2023 - 	 - Acompte juste paiement	
			if (isset($conf->global->FACTURE_DEPOSITS_ARE_JUST_PAYMENTS ))
				$sql .= " AND type <> 3 ";
// Fin Modif CCA 20/12/2023 
		}
		if ($search_status == '2') {
...
// Modif CCA 27/01/2019 - Acompte juste paiement
				if ((!empty($conf->global->FACTURE_DEPOSITS_ARE_JUST_PAYMENTS)	 and $obj->type <> 3) or empty($conf->global->FACTURE_DEPOSITS_ARE_JUST_PAYMENTS))
// Fin Modif CCA
