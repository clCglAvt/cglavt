 ...
 * Copyright (C) 2022       Sylvain Legrand         <contact@infras.fr>
  *
 * MODIF CCA - 25/5/16  - manager les triggers de addline  
 * Modif CCA - 1/12/2019 - Erreur Paiement Acompte par Stripe 
 * Modif CCA - 16/7/22 Securisation ordre SQL	
				...
				foreach ($this->lines as $i => $val) {
					...
					if ($result >= 0) {
						...
						$result = $this->addline(
							...
							$line->ref_ext
//MODIF CCA - manager les triggers de addline-insert-update  - 25/5/16 
							, $notrigger
//Fin MODIF CCA - manager les triggers de addline-insert-update  - 25/5/16 
						);
						if ($result < 0) {
							$this->error = $this->db->lasterror();
...
// MODIF CCA - 25/5/16  - manager les triggers de addline-insert-update  
	 *		@param		int			$notrigger			manage les triggers 1=desactive ; 0 = active
// FIN modif CCA - 25/5/16 
...
// Modif CCA - 1/12/2019 - Erreur Paiement Acompte par Stripe 
			$this->user_author		= $objp->fk_user_author;
// Fin Modif CCA Erreur Paiement Acompte par Stripe 1/12/2019
