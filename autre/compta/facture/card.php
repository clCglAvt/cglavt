 ...
 *
 * MODIF CCA - 26/04/2021 - saisie du prix et taux TVA en mode Produit Prédéfini - Migration V12
 * MODIF CCA - 24/02/2022 - Cohérence entre opérateur logique et expression à tester - Migration V12
 *
...
//MODIF CCA - 24/02/2022 - Cohérence entre opérateur logique et expression à tester - Migration V12			
			...
			if (empty($conf->global->MAIN_DISABLE_PDF_AUTOUPDATE) && (count($object->lines)>0)) {
//Fin Modif 		CCA - 24/02/2022		
				$outputlangs = $langs;
				$newlang = '';
				if ($conf->global->MAIN_MULTILANGS && empty($newlang) && GETPOST('lang_id', 'aZ09')) {
					$newlang = GETPOST('lang_id', 'aZ09');
...
//MODIF CCA - 26/04/2021 - saisie du prix et taux TVA en mode Produit Prédéfini - Migration V12
				...
				// Si on a saisie un taux TVA il faut le récupérer				
				$tva_tx = (GETPOST('tva_tx', 'alpha') ? GETPOST('tva_tx', 'alpha') : $datapriceofproduct['tva_tx']);
//Fin MODIF CCA - 26/04/2021 -			
