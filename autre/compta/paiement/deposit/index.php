 ...
 * Modif CCA 10/1/2018 - fl_regroup et fl_regroupneg
...
//	$sql.= " LEFT JOIN ".MAIN_DB_PREFIX."paiement as p ON p.fk_bank = b.rowid";
	...
	$sql.= " LEFT JOIN (
		SELECT 1, p1.rowid, p1.fk_paiement, p1.fk_bank FROM llx_paiement as p1
			WHERE YEAR(p1.datec) > 2022 
		UNION
		SELECT 2, p2.rowid, p2.fk_typepayment  , p2.fk_bank FROM llx_payment_various as p2
			WHERE YEAR(p2.datec) > 2022 
		UNION
		SELECT 3, p3.rowid, p3.fk_paiement, p3.fk_bank FROM llx_paiementfourn as p3
			WHERE p3.amount < 0 AND YEAR(p3.datec) > 2022 
	) as p ON p.fk_bank = b.rowid";
...
//Fin  Modif CCA 10/1/2018 - fl_regroup et fl_regroupneg
