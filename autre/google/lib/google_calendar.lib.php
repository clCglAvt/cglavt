 ...
 *
 * MODIF CCA 10/6/15
 * Le tableau userassigned est vide et il bloque tout
 
 * MODIF CCA 14/4/2019  le point sur l'objet db n'est pas une variable global mais dépend de la classe
 *
...
function createEvent($client, $object, $login='primary')
{
	...
	$attendees = array();
// MODIF CCA 10/6/15
	if (isset($object->userassigned) and  !empty($object->userassigned)) 
// FIN MODIF CCA
